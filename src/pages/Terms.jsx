      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-sm text-neutral-500 font-light max-w-xl mx-auto">
            Last Updated: July 20, 2026. Please review our order supply and installation terms for Eternal Techworks.
          </p>
        </div>
        ...
        <div className="bg-white border border-neutral-200/80 p-8 rounded-3xl shadow-xs space-y-4">
          ...
          <p className="text-xs text-neutral-600 leading-relaxed font-light">
            By requesting a price quote, placing a purchase order, or engaging Eternal Techworks for the supply, fabrication, and installation of sandwich PUF/PIR panels, corrugated profile sheets, or prefabricated cabins, you agree to be bound by these Terms of Service. These terms govern all transactions, engineering specifications, and supply agreements between you (the "Client") and Eternal Techworks.
          </p>
        </div>
        ...
        <div className="bg-white border border-neutral-200/80 p-8 rounded-3xl shadow-xs space-y-6">
          <h2 className="text-lg font-bold text-neutral-900 flex items-center space-x-2">
            ...
            <span>2. Custom Order &amp; Spec Approvals</span>
          </h2>
          
          <div className="space-y-4 text-xs text-neutral-600 font-light leading-relaxed">
            <p>
              Since sandwich panels (PUF/PIR/Rockwool/Glasswool) are supplied to custom order, the Client is responsible for verifying the correctness of all specifications listed in the signed sales order:
            </p>
            <ul className="list-disc pl-5 space-y-2">
              <li><strong>Panel Core Type &amp; Thickness:</strong> Standard PUF/PIR density of 40 &plusmn; 2 kg/m&sup3; with requested core thickness (e.g., 30mm, 50mm, 100mm).</li>
            ...
            <div className="p-4 bg-amber-50/50 border border-amber-200/60 rounded-2xl flex items-start space-x-3 text-amber-800 text-[11px] leading-relaxed">
              ...
              <span>
                <strong>Important Notice:</strong> Once order processing has commenced at the manufacturer's production facility, no order modifications, cancellations, or thickness alterations can be accommodated. All custom-supplied items are non-refundable.
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-neutral-200/80 p-8 rounded-3xl shadow-xs space-y-4">
          ...
          <div className="space-y-3 text-xs text-neutral-600 font-light leading-relaxed">
            ...
            <ul className="list-decimal pl-5 space-y-1.5">
              ...
              <li>The balance payment of <strong>50%</strong> to be cleared upon order readiness, prior to dispatch.</li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-white border border-neutral-200/80 p-8 rounded-3xl shadow-xs space-y-4">
          ...
          <div className="space-y-3 text-xs text-neutral-600 font-light leading-relaxed">
            <p>
              All dispatches are sold Ex-Factory. While Eternal Techworks can assist in coordinating third-party flatbed or open-body transit trucks, freight charges and transit insurance remain the sole responsibility of the Client.
            </p>
            <p>
